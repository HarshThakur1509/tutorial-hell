...
async function sendDataToBackend(data) {
    try {
        ...
        const backendUrl = 'https://youtube.harshthakur.site/api';
        const frontendUrl = 'https://youtube.harshthakur.site';
...
const getCookie = async () => {
    return new Promise((resolve) => {
        chrome.cookies.get({ url: 'https://youtube.harshthakur.site', name: '_gothic_session' }, (cookie) => {
